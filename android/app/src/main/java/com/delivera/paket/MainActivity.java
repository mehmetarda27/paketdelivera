...
public class MainActivity extends BridgeActivity {
    private static final String COURIER_URL = "https://paketdelivera-1.onrender.com/courier.html";
    private static final String NOTIFICATION_CHANNEL_ID = "delivera_paket_courier";
    ...
    private static String offlineHtml() {
        return (
            ...
            "</head><body><main class=\"card\"><div class=\"mark\">D</div><h1>Delivera Paket</h1>" +
    ...
    private static class DeliveraWebViewClient extends BridgeWebViewClient {
        ...
        private void injectNotificationBridge(WebView view) {
            view.evaluateJavascript(
                ...
                "options=options||{};" +
                "window.DeliveraNativeNotifications.show(String(title||'Delivera Paket'),String(options.body||''));" +
                "}" +
        ...
        private boolean isAllowedInAppUrl(Uri uri) {
            ...
            return (
                host.equals("paketdelivera-1.onrender.com") ||
    ...
    private static class NotificationBridge {
        ...
        public void show(String title, String body) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(activity, NOTIFICATION_CHANNEL_ID)
                ...
                .setContentTitle(title == null || title.isEmpty() ? "Delivera Paket" : title)
